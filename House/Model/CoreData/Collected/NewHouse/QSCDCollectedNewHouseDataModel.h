//
//  QSCDCollectedNewHouseDataModel.h
//  House
//
...
@class QSCDCollectedNewHouseActivityDataModel, QSCDCollectedNewHouseAllHousesDataModel, QSCDCollectedNewHousePhotoDataModel, QSCDCollectedNewHouseRecommendHousesDataModel;

@interface QSCDCollectedNewHouseDataModel : NSManagedObject
...
- (void)addPhotosObject:(QSCDCollectedNewHousePhotoDataModel *)value;
- (void)removePhotosObject:(QSCDCollectedNewHousePhotoDataModel *)value;
- (void)addPhotos:(NSSet *)values;
- (void)removePhotos:(NSSet *)values;

- (void)addActivitiesObject:(QSCDCollectedNewHouseActivityDataModel *)value;
- (void)removeActivitiesObject:(QSCDCollectedNewHouseActivityDataModel *)value;
- (void)addActivities:(NSSet *)values;
- (void)removeActivities:(NSSet *)values;

- (void)addRecommend_housesObject:(QSCDCollectedNewHouseRecommendHousesDataModel *)value;
- (void)removeRecommend_housesObject:(QSCDCollectedNewHouseRecommendHousesDataModel *)value;
- (void)addRecommend_houses:(NSSet *)values;
- (void)removeRecommend_houses:(NSSet *)values;

- (void)addAll_housesObject:(QSCDCollectedNewHouseAllHousesDataModel *)value;
- (void)removeAll_housesObject:(QSCDCollectedNewHouseAllHousesDataModel *)value;
