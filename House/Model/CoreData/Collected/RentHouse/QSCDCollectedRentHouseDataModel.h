//
//  QSCDCollectedRentHouseDataModel.h
//  House
//
...
@class QSCDCollectedRentHousePhotoDataModel;

@interface QSCDCollectedRentHouseDataModel : NSManagedObject
...
@interface QSCDCollectedRentHouseDataModel (CoreDataGeneratedAccessors)

- (void)addPhotosObject:(QSCDCollectedRentHousePhotoDataModel *)value;
- (void)removePhotosObject:(QSCDCollectedRentHousePhotoDataModel *)value;
