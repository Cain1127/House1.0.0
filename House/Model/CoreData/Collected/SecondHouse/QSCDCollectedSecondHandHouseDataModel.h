//
//  QSCDCollectedSecondHandHouseDataModel.h
//  House
//
...
@class QSCDCollectedSecondHandHousePhotoDataModel;

@interface QSCDCollectedSecondHandHouseDataModel : NSManagedObject
...
@property (nonatomic, retain) NSString * price_change_id_;
@property (nonatomic, retain) NSString * price_change_type;
@property (nonatomic, retain) NSString * price_change_obj_id;
@property (nonatomic, retain) NSString * price_change_title;
@property (nonatomic, retain) NSString * price_change_before_price;
@property (nonatomic, retain) NSString * price_change_revised_price;
@property (nonatomic, retain) NSString * price_change_update_time;
@property (nonatomic, retain) NSString * price_change_create_time;
...
@interface QSCDCollectedSecondHandHouseDataModel (CoreDataGeneratedAccessors)

- (void)addPhotosObject:(QSCDCollectedSecondHandHousePhotoDataModel *)value;
- (void)removePhotosObject:(QSCDCollectedSecondHandHousePhotoDataModel *)value;
