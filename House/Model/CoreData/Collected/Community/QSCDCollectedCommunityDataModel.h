...
@class QSCDCollectedCommunityHouseDataModel, QSCDCollectedCommunityPhotoDataModel, QSCDCollectedCommunityRentHouseDataModel;
...
@property (nonatomic, retain) NSSet *rent_houses;
...
- (void)addRent_housesObject:(QSCDCollectedCommunityRentHouseDataModel *)value;
- (void)removeRent_housesObject:(QSCDCollectedCommunityRentHouseDataModel *)value;
- (void)addRent_houses:(NSSet *)values;
- (void)removeRent_houses:(NSSet *)values;
