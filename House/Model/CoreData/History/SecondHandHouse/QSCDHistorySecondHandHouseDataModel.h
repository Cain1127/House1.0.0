//
//  QSCDHistorySecondHandHouseDataModel.h
//  House
//
...
@class QSCDHistorySecondHandHousePhotoDataModel;

@interface QSCDHistorySecondHandHouseDataModel : NSManagedObject
...
@interface QSCDHistorySecondHandHouseDataModel (CoreDataGeneratedAccessors)

- (void)addPhotosObject:(QSCDHistorySecondHandHousePhotoDataModel *)value;
- (void)removePhotosObject:(QSCDHistorySecondHandHousePhotoDataModel *)value;
