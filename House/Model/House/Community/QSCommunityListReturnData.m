...
+ (RKObjectMapping *)objectMapping
{
    ...
    [shared_mapping addPropertyMapping:[RKRelationshipMapping relationshipMappingFromKeyPath:@"referrals_list" toKeyPath:@"referrals_list" withMapping:[QSCommunityDataModel objectMapping]]];
