...
+ (void)presentedView:(UIView *)view andCustomModalType:(CUSTOM_MODALPRESENTATION_STYLE)modalPresentation
{
    ...
    if (rootVC) {
        ...
        [rootVC presentViewController:custonShowVC animated:YES completion:nil];
        
    } else {
        
        rootVC = [[UIApplication sharedApplication].keyWindow.rootViewController presentedViewController];
