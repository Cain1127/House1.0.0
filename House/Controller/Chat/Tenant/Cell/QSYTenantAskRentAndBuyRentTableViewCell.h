//
//  QSYTenantAskRentAndBuyRentTableViewCell.h
//  House
//
...
typedef enum
{
    ...
    tTenantAskRentAndBuyRentCellActionTypeRecommendHouse = 99,    //!<推荐房源
    
}TENANT_ASK_RENTANDBUY_RENT_CELL_ACTION_TYPE;

@class QSYAskRentAndBuyDataModel;
@interface QSYTenantAskRentAndBuyRentTableViewCell : UITableViewCell
