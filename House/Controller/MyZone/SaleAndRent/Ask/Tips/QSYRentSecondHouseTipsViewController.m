//
//  QSYRentSecondHouseTipsViewController.m
//  House
//
...
@interface QSYRentSecondHouseTipsViewController ()

@property (nonatomic,copy) NSString *recommendID;//!<求购记录的ID

@end

@implementation QSYRentSecondHouseTipsViewController
...
- (void)createMainShowUI
{
    ...
    dispatch_after(dispatch_time(DISPATCH_TIME_NOW, (int64_t)(3.5f * NSEC_PER_SEC)), dispatch_get_main_queue(), ^{
        ...
        QSYAskRecommendSecondHouseViewController *recommendSecondHouseVC = [[QSYAskRecommendSecondHouseViewController alloc] initWithRecommendID:self.recommendID];
        [recommendSecondHouseVC setTurnBackDistanceStep:3];
