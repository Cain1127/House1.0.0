//
//  QSYHistoryHouseCollectionViewCell.m
//  House
//
...
- (void)updateSecondHandHouseInfoCellUIWithModel:(QSSecondHouseDetailDataModel *)tempModel andPickedBoxStatus:(BOOL)isPickedBoxShow
{
    ...
    ///更新详细街道信息
    [self updateHouseStreetInfo:tempModel.house.address];
    
    ///更新房子面积信息
    [self updateHouseAreaInfo:[NSString stringWithFormat:@"%d",[tempModel.house.house_area intValue]]];
    
    ///更新房子户型信息
    [self updateHouseTypeInfo:tempModel.house.house_shi and:tempModel.house.house_ting];
    
    ///更新中间标题
    [self updateTitleWithTitle:[NSString stringWithFormat:@"%d",[tempModel.house.house_price intValue] / 10000] andListType:fFilterMainTypeSecondHouse];
    ...
    ///更新房子特色标签
    [self updateHouseFeatures:tempModel.house.features andListType:fFilterMainTypeSecondHouse];
...
- (void)updateRentHouseInfoCellUIWithModel:(QSRentHouseDetailDataModel *)tempModel andPickedBoxStatus:(BOOL)isPickedBoxShow
{
    ...
    ///更新中间标题
    [self updateTitleWithTitle:[NSString stringWithFormat:@"%d",[tempModel.house.rent_price intValue]] andListType:fFilterMainTypeRentalHouse];
    ...
    ///更新房子特色标签
    [self updateHouseFeatures:tempModel.house.features andListType:fFilterMainTypeRentalHouse];
