...
@interface QSYRecommendRentHouseList () <QSCollectionWaterFlowLayoutDelegate,UICollectionViewDataSource,UICollectionViewDelegate>

///点击房源时的回调
@property (nonatomic,copy) void (^houseListTapCallBack)(HOUSE_LIST_ACTION_TYPE actionType,QSRentHouseInfoDataModel *tempModel);
...
@implementation QSYRecommendRentHouseList
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (0 == indexPath.row) {
        ...
        ///分隔线
        UILabel *sepLineLable = (UILabel *)[cellTitle.contentView viewWithTag:114];
        if (nil == sepLineLable) {
