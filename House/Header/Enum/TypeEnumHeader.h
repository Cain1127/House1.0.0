...
typedef enum
{
    ...
    qQSCustomProtocolChatMessageTypeRecommendHouse          = 9011, //!<业主推送房源的消息
    qQSCustomProtocolChatMessageTypeRecommendHouseHistory   = 9012, //!<历史推荐房源消息
...
typedef enum
{
    ...
    rRequestTypeHistoryNewHouseList = 2030,             //!<新房浏览记录列表
    ...
    rRequestTypeApplicationVersion = 9010,              //!<应用版本检测
    rRequestTypeCompanyComment = 9011,                  //!<意见反馈
